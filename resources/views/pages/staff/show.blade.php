...
<header>
    <div class="mx-auto max-w-9xl pt-2 pb-6 px-4">
        <h1 class="text-3xl font-bold tracking-tight">Info Petugas</h1>
    </div>
</header>
<main>
                            ...
                            <div class="px-4 py-4 sm:px-6">
                                <div class="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                                    <div class="sm:col-span-1">
                                        ...
                                        <p class="mt-2 text-xs">{{ $staff->name }}</p>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <p class="text-xs font-semibold">Jenis Kelamin</p>
                                        <p class="mt-2 text-xs">{{ $staff->position }}</p>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <p class="text-xs font-semibold">No Telp</p>
                                        <p class="mt-2 text-xs">{{ $staff->telephone }}</p>
                                    </div>
                                    <div class="sm:col-span-1">
                                        <p class="text-xs font-semibold">Alamat</p>
                                        <p class="mt-2 text-xs">{{ $staff->address }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
